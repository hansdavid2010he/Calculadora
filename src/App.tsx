...
export default function App() {
  ...
  useEffect(() => {
    ...
    root.classList.remove('theme-dark', 'theme-oled', 'theme-bronze', 'theme-glass');
    if (settings.theme === 'oled') {
      ...
      root.style.backgroundColor = '#0a0b10';
    } else {
  ...
  return (
    <div className={`min-h-screen flex flex-col justify-between overflow-hidden font-sans relative ${getThemeWrapperClass()}`} id="app-root-wrapper">
      
      {/* Background Glows for Glassmorphism */}
      {settings.theme === 'glass' && (
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
          <div className="absolute top-[-10%] left-[-15%] w-[80vw] h-[80vw] rounded-full bg-purple-600/10 blur-[130px] animate-pulse duration-[8s]" />
          <div className="absolute bottom-[-10%] right-[-15%] w-[80vw] h-[80vw] rounded-full bg-cyan-600/8 blur-[130px] animate-pulse duration-[12s]" />
        </div>
      )}
