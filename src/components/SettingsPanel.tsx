        ...
        <section className="space-y-4">
          ...
          <div className="p-4 bg-surface-container-low rounded-xl border border-surface-container-high space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 pt-2">
              ...
              <button
                onClick={() => handleModeChange('theme', 'glass')}
                className={`p-3 rounded-lg border text-center transition-all ${
                  settings.theme === 'glass'
                    ? 'bg-surface-container-high border-primary-container text-primary-fixed font-semibold shadow-inner'
                    : 'bg-surface border-surface-container hover:border-surface-container-highest text-on-secondary-container'
                }`}
              >
                <div className="w-4 h-4 rounded-full bg-gradient-to-r from-purple-500/40 to-cyan-500/40 border border-white/30 mx-auto mb-1.5 backdrop-blur-sm" />
